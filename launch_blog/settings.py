"""
Django settings for launch_blog project.
...
WSGI_APPLICATION = 'launch_blog.wsgi.application'
...
# path for the upload of rich text for posts
CKEDITOR_UPLOAD_PATH = 'uploads/'

# custom mommy class for testing - deal with rich text issue
MOMMY_CUSTOM_CLASS = ('mommy.CustomMommy')
